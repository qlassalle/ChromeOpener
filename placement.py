...
for j in range(0, 4):
	for i in range(0, 4):
		...
		launch_chrome_cmd = f"/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome https://coinlist.co/dashboard --args --profile-directory=Person{profile_number} &"
